            ...
            this.state.customer_orders.map((order, orderIdx) =>
              <div key={order.order_num} className="col-sm-12 col-md-4 mt-3">
                <div className="parent mb-4">
                  ...
                  <div className="card" data-toggle="modal" data-target={`.m${order._id}`}>
                ...
                <div className={`modal fade m${order._id}`} tabIndex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
